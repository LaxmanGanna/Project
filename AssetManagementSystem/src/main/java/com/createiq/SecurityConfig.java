...
//	}
	...
	protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(requests -> requests.antMatchers("/home").permitAll().antMatchers("/index").authenticated()
                ...
                .anyRequest().authenticated()).formLogin(login -> login.defaultSuccessUrl("/index", true)).logout(logout -> logout.logoutRequestMatcher(new AntPathRequestMatcher("/logout")));
